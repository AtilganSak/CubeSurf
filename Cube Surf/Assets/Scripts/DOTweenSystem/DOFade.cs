    ...
    public override void DO()
    {
        switch (fadeSource)
        {
            ...
            case FadeSource.Material:
                ...
                sourceMaterial.DOFade(endvalue, duration).SetDelay(doDelay).SetEase(ease).OnComplete(() => doComplete.Invoke());
                break;
        }
    }
    public override void DORevert()
    {
        switch (fadeSource)
        {
            ...
            case FadeSource.Material:
                ...
                sourceMaterial.DOFade(startValue, duration).SetDelay(revertDelay).SetEase(ease).OnComplete(() => doRevertComplete.Invoke());
                break;
        }
    }
    ...
    public override void DOLoop()
    {
        switch (fadeSource)
        {
            ...
            case FadeSource.Material:
                if (DOTween.IsTweening(sourceMaterial))
                    sourceMaterial.DOKill(true);
                sourceMaterial.DOFade(endvalue, duration).SetDelay(doDelay).SetEase(ease).SetLoops(-1, loopType);
                break;
        }
    }
